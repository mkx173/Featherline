...
data class TrackedDateEntity(
    ...
    // HeroBackground storage key: null for no background (default), "DATE_COLOR" for the
    // date color wash, or PrideFlag.name(). Legacy "NONE" rows also decode to no background.
