...
object DoseInstructionCalculator {
    ...
    private const val ESTRADIOL_UNDECYLATE_MOLECULAR_WEIGHT = 440.66
    private const val ESTRADIOL_UNDECYLATE_ACTIVE_MOLECULAR_WEIGHT = 272.38
    ...
    private val equivalenceRatios = mapOf(
        ...
        MedicationKey.ESTRADIOL_UNDECYLATE to ESTRADIOL_UNDECYLATE_ACTIVE_MOLECULAR_WEIGHT /
                ESTRADIOL_UNDECYLATE_MOLECULAR_WEIGHT,
