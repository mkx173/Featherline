...
class ReminderNotificationTextTest {
    ...
    @Test
    fun buildReminderNotificationText_summarizes_merged_groups_with_first_group_and_more_count() {
        val text = buildReminderNotificationText(
            bundle = reminderBundle(groupNames = listOf("Estradiol", "Spiro", "Progesterone"))
        )
